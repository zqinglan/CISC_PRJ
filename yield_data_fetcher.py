...
class YieldDataFetcher:
    ...
    def fetch_latest_data(self, days=365):
        """
        ...
        # Since Treasury data is monthly, we need to go back further to get enough observations
        ...
        # Don't limit the data since we need all available observations for forecasting
        # The Treasury API returns monthly data, so we need to preserve all observations
        return data
